...
endereco = Endereco.new("90900-909", "Centro", "Teresina")
maria = PessoaFisica.new("Maria Cardorso", "123.456.789-00", endereco)
empresa = PessoaJuridica.new("Empresa Exemplo", "12.345.678/0001-00", endereco)
